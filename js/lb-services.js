...
/**
 * @ngdoc object
 * @name lbServices.Door
 * @header lbServices.Door
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Door` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Door#create
         * @methodOf lbServices.Door
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Door` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/doors",
        ...
        /**
         * @ngdoc method
         * @name lbServices.Door#createMany
         * @methodOf lbServices.Door
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/doors/:id/exists",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Door#findById
         * @methodOf lbServices.Door
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/doors/:id",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Door#find
         * @methodOf lbServices.Door
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/doors/findOne",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Door#updateAll
         * @methodOf lbServices.Door
         *
         * @description
         *
         ...
         */
        "updateAll": {
          url: urlBase + "/doors/update",
          method: "POST"
        },

        /**
         * @ngdoc method
         * @name lbServices.Door#deleteById
         * @methodOf lbServices.Door
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/doors/count",
          method: "GET"
        },

        /**
         * @ngdoc method
         * @name lbServices.Door#prototype$updateAttributes
         * @methodOf lbServices.Door
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Door#createChangeStream
         * @methodOf lbServices.Door
         *
         * @description
         *
         ...
         */
        "createChangeStream": {
          url: urlBase + "/doors/change-stream",
          method: "POST"
        },
      }
    );
        ...
        /**
         * @ngdoc method
         * @name lbServices.Door#updateOrCreate
         * @methodOf lbServices.Door
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Door#destroyById
         * @methodOf lbServices.Door
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Door#removeById
         * @methodOf lbServices.Door
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Door#modelName
    * @propertyOf lbServices.Door
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Door`.
    */
